...
[배포처 바로가기](https://blog.naver.com/hp0/221372793233)

&nbsp;

## 웹 폰트

사용하는 `font-family`의 이름은 `HSGaeulsenggak2.0`입니다.
...
@font-face {
    ...
    src: url('https://cdn.jsdelivr.net/gh/fonts-archive/HSGaeulsenggak2.0/HSGaeulsenggak2.0.woff2') format('woff2'),
         ...
         url('https://cdn.jsdelivr.net/gh/fonts-archive/HSGaeulsenggak2.0/HSGaeulsenggak2.0.otf') format('opentype'),
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/HSGaeulsenggak2.0/subsets/HSGaeulsenggak2.0-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/HSGaeulsenggak2.0/subsets/HSGaeulsenggak2.0-dynamic-subset.css');
```
...
```css
font-family: "HSGaeulsenggak2.0", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
